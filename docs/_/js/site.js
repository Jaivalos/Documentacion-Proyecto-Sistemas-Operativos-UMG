  ...
  function p() {
    ...
    e && window.innerHeight + e + 2 >= document.documentElement.scrollHeight
      ? ((c = Array.isArray(c) ? c : Array(c || 0)),
        ...
        s.forEach(function (e, t) {
          ...
          t === i || e.getBoundingClientRect().top + h(e, "paddingTop") > r
            ? (n.push(o), c.indexOf(o) < 0 && l[o].classList.add("is-active"))
            : ~c.indexOf(o) && l[c.shift()].classList.remove("is-active");
        }),
      ...
      : (Array.isArray(c) &&
        ...
        t
          ? t !== c &&
            (c && l[c].classList.remove("is-active"),
            ...
            (c = t))
          : c && (l[c].classList.remove("is-active"), (c = void 0)));
  }
  function h(e, t) {
